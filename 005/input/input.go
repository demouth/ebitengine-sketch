...
import (
	...
	internalinput "github.com/ebitenui/ebitenui/internal/input2"
...
func HandleInput(p image.Point) {
	internalinput.InputHandler.HandleInput(p.X, p.Y)
}
...
func BeforeCommit() string {
	return internalinput.InputHandler.BeforeCommit()
}
func Composing() bool {
	return internalinput.InputHandler.Composing()
}
func Focus() {
	internalinput.InputHandler.Focus()
}
