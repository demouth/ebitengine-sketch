module github.com/demouth/ebitengine-sketch/016

go 1.22.6

require (
	github.com/ebitengine/microui v0.0.0-20240901185901-bbb4d8da3b6a
...
require (
	...
	github.com/hajimehoshi/bitmapfont/v3 v3.2.0-alpha.4 // indirect
